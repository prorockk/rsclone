import { app, PlayerMethod } from "../script.js";
import createPlayer from "./createPlayer.js";
import createGameElement from "../CreateSprite/createGameElement.js";
...
PlayerMethod.playerShooting = function (e) { //добавляем функции для скилов героя
    let bulletDirection;
    ...
    const bullet = createGameElement('./images/tear.png', (this.player.x), (this.player.y));
...
PlayerMethod.updateBullets = function () {
    for (let i = 0; i < this.bullets.length; i++) {
        ...
        //удаление пуль
        if (this.bullets[i].position.y < 0 || this.bullets[i].position.y > 512 || this.bullets[i].position.x < 0 || this.bullets[i].position.x > 512) {
